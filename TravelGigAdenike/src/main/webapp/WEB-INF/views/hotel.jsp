...
<div class="col-7 border rounded" style="margin-left:50px;">
	...
	<div id="listHotel">
		<table id='hotelTable'>
		<tr><th>HotelId</th><th>HotelName</th><th>Price</th><th>Rating</th><th>Image</th></tr>
		</table>
	</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">        
        <div class="col">
        	...
        	Hotel Name: <input readonly="true" class="form-control" type="text" id="modal_hotelName" data-hotelId="0" data-price="0"/>
        	...
        	<input style="margin-top:25px" class="btn btn-searchHotelRooms form-control btn-primary" type="button" id="bookRoomBtn" value="BOOK ROOM"/>       	
        </div>
